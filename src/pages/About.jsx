...
const About = () => {
  ...
  return (
    <section className="about bg-gray-950 text-white py-16 px-6 flex flex-col items-center">
      {/* Title Section */}
      <h2 className="text-4xl font-bold text-red-500 mb-6">About Marvel Meals</h2>
      ...
      <div className="max-w-4xl mx-auto text-center mb-12">
        <h3 className="text-3xl font-semibold text-yellow-400 mb-4">The Inspiration Behind Marvel Meals</h3>
      ...
      <div className="flex justify-center items-center space-x-10 mb-12">
        <div className="text-center">
          <h3 className="text-2xl font-semibold text-red-500">Vegetarian Dishes</h3>
          <p className="text-3xl font-bold text-yellow-400">{vegCount}</p>
        </div>
        <div className="text-center">
          <h3 className="text-2xl font-semibold text-red-500">Non-Vegetarian Dishes</h3>
          <p className="text-3xl font-bold text-yellow-400">{nonVegCount}</p>
        </div>
      </div>

      {/* Hero Dishes Section */}
      <div className="text-center mb-12">
        <h3 className="text-3xl font-semibold text-yellow-400 mb-4">Marvel Heroes and Their Dishes</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl">
          <div className="bg-gray-800 rounded-lg shadow-lg transform hover:scale-105 transition duration-300">
            <div className="p-6 text-center">
              <img
                src="https://i.pinimg.com/originals/42/ed/91/42ed9167aa2dce961de6d1d6bfc8a3d4.jpg"
                alt="Iron Man Dish"
                className="rounded-lg shadow-md mb-4 object-cover h-40 w-full"
              />
      ...
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 text-center mb-12 max-w-3xl mx-auto">
      ...
      <div className="max-w-4xl mx-auto text-center mb-12">
        <h3 className="text-3xl font-semibold text-yellow-400 mb-4">What Our Heroes Say</h3>
